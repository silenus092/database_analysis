...
public class main {
	...
	public static void RunAnalysis_Criteria(){
		 ArrayList<Double> temp_time_arraylist ;
		 temp_time_arraylist = new ArrayList<Double>();
		 System.out.println(" ************* [Main] RunAnalysis_Criteria *************");
		 MySQLAccess_ClinicalStudyTable clinical_study =  test.getClinical_studyTable_instance();
		 MySQLAccess_GeneTable geneTable = test.getGeneTable_instance();
		 ...
		 for(int i = 0 ; i < geneTable.getArrayListGenesets().size() ; i++){
			 //System.out.println("[Main] Gene Symbol  : "+test.getGeneTable_instance().getArrayListGenesets().get(i).getSymbol());
			 clinical_study.RunAnalysis_BriefTitle(MySQLAccess_Config.criteria_query1_LIKE_BINARY_SYMBOL , test.getGeneTable_instance().getArrayListGenesets().get(i).getSymbol());
			 temp_time_arraylist.add(clinical_study.getElapsed_time());
		 }
		 ...
		 for(int i = 0 ; i < geneTable.getArrayListGenesets().size() ; i++){
			 //System.out.println("[Main] Gene Symbol  : "+test.getGeneTable_instance().getArrayListGenesets().get(i).getSymbol());
			 clinical_study.RunAnalysis_BriefTitle(MySQLAccess_Config.criteria_query1_LIKE_SYMBOL , test.getGeneTable_instance().getArrayListGenesets().get(i).getSymbol());
			 temp_time_arraylist.add(clinical_study.getElapsed_time());
		 }
		 System.out.println("[Main] getTotal_row  : "+clinical_study.getTotal_row());
		 System.out.println("[Main] getTotal_elapsed_time : "+ clinical_study.getTotal_elapsed_time());
		 ...
		 for(int i = 0 ; i < geneTable.getArrayListGenesets().size() ; i++){
			 ...
			 clinical_study.RunAnalysis_BriefTitle_Name(test.get_connect_instance(),MySQLAccess_Config.criteria_query2_LIKE_BINARY_NAME , test.getGeneTable_instance().getArrayListGenesets().get(i).getName());
			 temp_time_arraylist.add(clinical_study.getElapsed_time());
		 }
		 System.out.println("[Main] getTotal_row  : "+clinical_study.getTotal_row());
		 System.out.println("[Main] getTotal_elapsed_time : "+ clinical_study.getTotal_elapsed_time());
		 ...
		 for(int i = 0 ; i < geneTable.getArrayListGenesets().size() ; i++){
			 //System.out.println("[Main] Gene Symbol  : "+test.getGeneTable_instance().getArrayListGenesets().get(i).getSymbol());
			clinical_study.RunAnalysis_BriefTitle_Name(test.get_connect_instance(),MySQLAccess_Config.criteria_query2_LIKE_NAME , test.getGeneTable_instance().getArrayListGenesets().get(i).getName());
			 temp_time_arraylist.add(clinical_study.getElapsed_time());
		 }
		 System.out.println("[Main] getTotal_row  : "+clinical_study.getTotal_row());
		 System.out.println("[Main] getTotal_elapsed_time : "+ clinical_study.getTotal_elapsed_time());
		 ...
		 for(int i = 0 ; i < geneTable.getArrayListGenesets().size() ; i++){
			 //System.out.println("[Main] Gene Symbol  : "+test.getGeneTable_instance().getArrayListGenesets().get(i).getSymbol());
			clinical_study.RunANalysis_BriefTitle_SYMBOL_NAME(test.get_connect_instance(),MySQLAccess_Config.criteria_query3_LIKE_BINARY_SYMBOL_NAME, test.getGeneTable_instance().getArrayListGenesets().get(i).getSymbol() ,test.getGeneTable_instance().getArrayListGenesets().get(i).getName());
			 temp_time_arraylist.add(clinical_study.getElapsed_time());
		 }
		 System.out.println("[Main] getTotal_row  : "+clinical_study.getTotal_row());
		 System.out.println("[Main] getTotal_elapsed_time : "+ clinical_study.getTotal_elapsed_time());
		 ...
		 for(int i = 0 ; i < geneTable.getArrayListGenesets().size() ; i++){
			 //System.out.println("[Main] Gene Symbol  : "+test.getGeneTable_instance().getArrayListGenesets().get(i).getSymbol());
			clinical_study.RunANalysis_BriefTitle_SYMBOL_NAME(test.get_connect_instance(),MySQLAccess_Config.criteria_query3_LIKE_SYMBOL_NAME, test.getGeneTable_instance().getArrayListGenesets().get(i).getSymbol() ,test.getGeneTable_instance().getArrayListGenesets().get(i).getName());
			 temp_time_arraylist.add(clinical_study.getElapsed_time());
		 }
		 System.out.println("[Main] getTotal_row  : "+clinical_study.getTotal_row());
		 System.out.println("[Main] getTotal_elapsed_time : "+ clinical_study.getTotal_elapsed_time());
